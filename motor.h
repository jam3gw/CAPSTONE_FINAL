...
#define NENBL_BIT                      BIT2
#define NENBL_PORT                     P1OUT
#define NENBL_DDR                      P1DIR
...
#define STEP_BIT                      BIT3
#define STEP_PORT                     P1OUT
#define STEP_DDR                      P1DIR
